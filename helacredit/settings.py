"""
Django settings for helacredit project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', '*', '.onrender.com', 'helafund.co.ke', 'www.helafund.co.ke']
...
WSGI_APPLICATION = 'helacredit.wsgi.application'
